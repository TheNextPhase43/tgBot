...
bot.hears("skibidi", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: 
            ...
            return [4 /*yield*/, fetch("\nhttps://\nwww\n.googleapis\n.com\n/youtube\n/v3\n/search\n?part=snippet\n&channelId=".concat(process.env.DA_FUQ_BOOM_CHANNEL_ID, "\n&order=date\n&maxResults=1\n&key=").concat(process.env.YOUTUBE_DATA_API_V3_KEY, "\n"))
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, ctx.reply("https://www.youtube.com/watch?v=".concat(json.items[0].id.videoId))];
...
bot.hears("пихаил чмо", function (ctx) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    ctx.react("❤");
    return [2 /*return*/];
}); }); });
...
bot.on("message", function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, ctx.reply("skibidi ".concat(ctx.chatId))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
